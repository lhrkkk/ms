...
@as_method_of(Atom)
def moving(self,trans):

    self.coord=(self.get_vector()+trans).get_array()

@as_method_of(Atom)
def __sub__(self,other):

    return (self.get_vector()-other.get_vector()).get_array()
...
class Conformer(Polypeptide):
    ...
    def moving_by_atom(self, from_atom, target_atom):
        '''
